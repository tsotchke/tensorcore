...
31/31 should pass on Apple M2 Ultra in roughly 5-15 s. The default CTest
suite is 27 library/package tests plus four executable example smokes:
...
example_mesh_training_demo_checkpoint
