 ...
 * TC_DIST_SINGLE, GLOO TCP collectives, and GEMM. Other public ABI entry
 * points return a stable unsupported status so Python/ctypes and downstream
 * FFI imports can bind the full surface without requiring Metal symbols.
 */
