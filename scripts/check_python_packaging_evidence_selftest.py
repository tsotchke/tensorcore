...
def coverage() -> dict[str, Any]:
    return {
        "setup.py": {
            ...
            "functions": {
                "_artifact_dirs": {"start_line": 30, "executed_lines": [30]},
                "_dylib_arches": {"start_line": 115, "executed_lines": [115]},
                "_dylib_macos_version": {"start_line": 130, "executed_lines": [130]},
                "_find_native_artifacts": {"start_line": 71, "executed_lines": [71]},
                "_macos_platform_tags": {"start_line": 137, "executed_lines": [137]},
                "_metallib_required": {"start_line": 64, "executed_lines": [64]},
                "_platform_library_names": {"start_line": 54, "executed_lines": [54]},
                "_run_tool": {"start_line": 92, "executed_lines": [92]},
                "_validate_dylib_matches_platform_tag": {
                    "start_line": 147,
                    "executed_lines": [147],
                },
                "_wheel_macos_version": {"start_line": 123, "executed_lines": [123]},
...
def passed_evidence() -> dict[str, Any]:
    return {
        ...
        "summary": {
            ...
            "failure_reason": None,
            "required_functions": [
                "setup.py:_artifact_dirs",
                "setup.py:_dylib_arches",
                "setup.py:_dylib_macos_version",
                "setup.py:_find_native_artifacts",
                "setup.py:_macos_platform_tags",
                "setup.py:_metallib_required",
                "setup.py:_platform_library_names",
                "setup.py:_run_tool",
                "setup.py:_validate_dylib_matches_platform_tag",
                "setup.py:_wheel_macos_version",
                "setup.py:bdist_wheel_with_native_artifacts.finalize_options",
                "setup.py:bdist_wheel_with_native_artifacts.get_tag",
