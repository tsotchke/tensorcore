...
import check_pytorch_smoke_evidence_selftest as pytorch_fixture
...
def pytorch_evidence() -> dict[str, Any]:
    evidence = pytorch_fixture.passed_evidence()
    evidence["git_head"] = TEST_HEAD
    evidence["git_dirty"] = False
    return evidence
